...
export default function ProfilePage() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-2xl border-x border-zinc-800 bg-black">
      ...
      <section className="px-5 pt-20 pb-6">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-[15px] text-zinc-500">@{user.username}</p>
          </div>
          <Button
            variant="ghost"
            size="icon"
        ...
        {user.bio ? (
          ...
          <p className="mt-5 text-[15px] italic text-zinc-500">No bio yet.</p>
        )}
      ...
      <div className="mx-5 mb-6 p-5 border border-zinc-800 rounded-2xl bg-gradient-to-br from-sky-500/10 to-transparent">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-2xl font-black text-sky-500 tracking-tight">
              {currentPlan}
            </p>
            {isPremium && (
          ...
          <Link
            href="/subscriptions"
            className="inline-flex items-center justify-center px-6 py-2.5 bg-white text-black font-bold rounded-full hover:bg-zinc-200 transition-colors"
          >
