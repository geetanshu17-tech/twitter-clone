...
import { Image, Smile, Calendar, MapPin, BarChart3, Globe, X } from "lucide-react"; // Added X for the remove button
...
const TweetComposer = ({ onTweetPosted }: any) => {
  ...
  const handleSubmit = async (e: any) => {
    e.preventDefault();
    // FIX: Allow post if there is EITHER content OR an image
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-3">
                    {/* ... progress circle code ... */}
                    <Separator orientation="vertical" className="h-6 bg-gray-700" />

                    <Button
                      type="submit"
                      
                      disabled={(!content.trim() && !imageurl) || isOverLimit || isLoading}
